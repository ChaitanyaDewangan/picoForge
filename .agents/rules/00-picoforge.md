...
- Standing orders live in .agents/AGENTS.md — read it before any task; it wins on conflict.
- The normative spec pack is in KNOWLEDGE_BASE (SYS_DESIGN, LLM_HARNESS, DATA_SCHEMA, UIUX,
