...
if not exist ".env" (
    ...
    echo [INFO] Created .env — add your API key there or use Settings in the app.
)
...
start "PicoForge Server" cmd /c "deno run --watch --allow-net --allow-read --allow-write --allow-run --allow-env server/main.ts"
